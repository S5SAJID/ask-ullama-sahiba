        ...
        <nav className="bg-white/50 backdrop-blur fixed z-10 left-0 right-0 top-0 border-b border-neutral-600/40 dark:bg-gray-900/50">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="flex md:order-2">
                    <button onClick={() => setIsMenuOpen(!isMenuOpen)} type="button" data-collapse-toggle="navbar-search" aria-controls="navbar-search" aria-expanded="false" className="md:hidden text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 me-1">
                    ...
                    <button onClick={() => setIsMenuOpen(!isMenuOpen)} data-collapse-toggle="navbar-search" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-search" aria-expanded="false">
                ...
                <div className={`items-center justify-between ${isMenuOpen ? "" : "hidden"} w-full md:flex md:w-auto md:order-1`} id="navbar-search">
                    ...
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700">
                        <li>
                            <Link href="/" className={`block ${active=='home'? 'active-nav': ""} py-2 px-3 text-white bg-primary-700 rounded md:bg-transparent relative md:p-0 md:d`} aria-current="page">Home</Link>
                        </li>
                        <li>
                            <Link href="/about" className={`block ${active=='about'? 'active-nav': ""} py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent relative md:hover:text-primary-700 md:p-0 md:dark:hover:text-primary-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700`}>About</Link>
                        </li>
                        <li>
                            <Link href="/posts" className={`block ${active=='posts'? 'active-nav': ""} py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent relative md:hover:text-primary-700 md:p-0 dark:text-white md:dark:hover:text-primary-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700`}>Posts</Link>
                        </li>
                    </ul>
                </div>
            </div>
